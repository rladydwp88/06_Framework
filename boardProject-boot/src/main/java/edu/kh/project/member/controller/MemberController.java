...
public class MemberController {
	...
	public String login(Member inputMember, RedirectAttributes ra, Model model,
		...
		if(loginMember == null) {
			...
			// 쿠키 객체 생성(K:V)
			Cookie cookie = new Cookie("savaId", loginMember.getMemberEmail());
	...
	/** 회원가입
	 * @param inputMember : 입력된 회원 정보(memberEmail, memberPw, memberNickname, memberTel, memberAddress(따로 배열로 받아 처리)
