...
public class EmailConfig {
	 ...
	 * 3. Google SMTP 서버가 이메일 주소에 맞는 "수신자"에게
	 * 	  이메일 서버(gmail, yahoo, 회사 이메일 서버 등)를 통해 발송.
	 * 4. 최종 수신자 이메일을 받음. 기본 포트 25를 사용하지만,
	 * 	  보안 강화한 포트 587이나 465가 자주 사용됨.
	 */
	...
	public JavaMailSender javaMailSender() {
		/*
		 * Spring에서 JavaMailSender를 구성하는 Bean을 정의하기 위한 메서드. JavaMailSender : 이메일을 보내는데
		 * 사용되는 인터페이스로 JavaMailSenderImpl 클래스를 통해 구현됨. SMTP 서버를 사용하여 이메일을 보내기 위한 구성을 제공.
		 * 
		 */
