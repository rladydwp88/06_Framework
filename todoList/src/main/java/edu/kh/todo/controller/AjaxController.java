 ...
 * 
 * -> 컨트롤러 메서드의 반환값을
 * 	  비동기 요청했던 HTML/JS 파일 부분에 값을 그대로 돌려 보낼것이다 를 명시.
 * 
 * -> 해당 어노테이션이 붙은 컨트롤러의 메서드는 return에 작성된 값이 forward/redirect 로 인식X
 * 
 * @RequestBody
...
public class AjaxController {
	...
	@ResponseBody // 반환 값을 HTTP 응답 본문으로 직접 전송(값 그대로 돌려보낼거야!!)
